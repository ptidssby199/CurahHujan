    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          {isOpenDropdown && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl z-50 p-3 space-y-2.5 max-h-96 flex flex-col animate-in fade-in zoom-in-95">
